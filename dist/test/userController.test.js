...
(0, vitest_1.describe)("menuSearch", function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, vitest_1.it)("should return a list of results", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, sql_1["default"])(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT * FROM users ORDER BY RANDOM() LIMIT 1"], ["SELECT * FROM users ORDER BY RANDOM() LIMIT 1"])))];
                    case 1:
                        user = (_a.sent())[0];
        ...
        (0, vitest_1.it)("should not return a user", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        (0, vitest_1.it)("should not return a user when wrong id is send", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
